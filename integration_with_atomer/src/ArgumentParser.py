...
class MyArgumentParser:
    def __init__(self):
        self.parser = argparse.ArgumentParser(
            description=(
                ...
                "The Atomer plugin outputs its results into a 'report.json' file after analyzing "
                "a given program. This script takes that output and generates a configuration file "
                "which can then be passed to the ANaConDA framework to enhance the accuracy and "
        ...
        self.parser.add_argument(
            "--atomer_output_to_executable_mappings_file",
            required=True,
            help="Path to the mapping file. Which maps an each Atomer output to an executable, "
                 "which will be analysed by Anaconda. An example can be found in example/mappings.txt"
        )
        self.parser.add_argument(
            "--atomer_outputs_dir",
            required=True,
            help="Path to the directory with outputs generated by Atomer. For our example it would be example/atomer_outputs"
        )
    ...
    def verify_arguments(args):
        ...
        paths_to_check = {
            ...
            "Mapping file": args.atomer_output_to_executable_mappings_file,
        }
